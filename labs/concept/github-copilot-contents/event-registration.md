...
<body class="bg-dark text-light">
    <nav class="navbar navbar-dark bg-dark">
        ...
        <a class="btn btn-secondary" href="/EventRegistration">Register for Event</a>
    </nav>
    <div class="mx-5 mb-5">
        <div class="card">
...
## 2. Pages/EventRegistration.cshtml

```html
@page
@model Web.Pages.EventRegistrationModel
@{
...
<body class="bg-dark text-light">
    <nav class="navbar navbar-dark bg-dark">
        <span class="navbar-brand mb-0 h1">Event Registration</span>
            ...
            <div class="card-body">
                <form method="post">
                    <div class="form-group">
                        <label asp-for="FullName" class="text-dark">Full Name</label>
...
## 3. Pages/EventRegistration.cshtml.cs
...
namespace Web.Pages
{
    public class EventRegistrationModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            // Handle the registration logic here (e.g., save to database)
